...
class UserSessionsControllerTest < ActionController::TestCase
  ...
  test "should create user_session" do
    assert_difference('UserSession.count') do
      post :create, user_session: { destroy: @user_session.destroy, email: @user_session.email, new: @user_session.new, password: @user_session.password }
    end
  ...
  test "should update user_session" do
    put :update, id: @user_session, user_session: { destroy: @user_session.destroy, email: @user_session.email, new: @user_session.new, password: @user_session.password }
    assert_redirected_to user_session_path(assigns(:user_session))
  end
